...
Modified by Charles Holtforster from original Unity version.
*/

[AddComponentMenu("Mesh/Combine Children - remove children")]
public class CombineChildrenModded : MonoBehaviour {
	...
	void Start () {
		...
		Transform[] oldChildren = GetComponentsInChildren<Transform>();
		...
		foreach (Transform T in oldChildren) {
